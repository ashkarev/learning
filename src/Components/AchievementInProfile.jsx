...
const AchievementProfile = () => {
  ...
  return (
    ...
    <div className="">
      ...
      <Card className="col-span-3 rounded-2xl border-0 shadow-sm p-6 my-10">
        ...
        <div className="grid grid-cols-2 gap-10 items-center">
          ...
          <div className="border-1 border-gray-200 rounded-xl p-6 flex flex-col items-center shadow-lg w-100 hover:scale-105 duration-700">
          ...
          <div className="grid gap-3 w-100">
            ...
            <Card className="rounded-xl border-1 border-gray-200 items-center shadow-lg w-100 hover:scale-105 duration-700 p-3">
